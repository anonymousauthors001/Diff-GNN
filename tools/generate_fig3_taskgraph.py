...
def write_taskgraph_pickle(pkl_out: str, area_constraint: float) -> None:
    ...
    nx.set_node_attributes(tg.legacy_graph, tg.hardware_area, "area_cost")
    nx.set_node_attributes(tg.legacy_graph, tg.hardware_costs, "hardware_time")
    nx.set_node_attributes(tg.legacy_graph, tg.software_costs, "software_time")
    nx.set_edge_attributes(tg.legacy_graph, tg.communication_costs, "communication_cost")
